...
public class CountKStreamPersonWithDeserializationExceptionHandler {
    public static void main(String[] args) {
        Properties streamProperties = new Properties();
        streamProperties.put(StreamsConfig.APPLICATION_ID_CONFIG, "personcountwithexcphandler_app_id");
