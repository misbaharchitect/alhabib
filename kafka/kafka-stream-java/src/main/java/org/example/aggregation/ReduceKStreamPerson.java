...
public class ReduceKStreamPerson {
    ...
    public static Topology build() {
       ...
       inputStream.peek((k,v) -> System.out.println("k-" + k + " : v-" + v))
               ...
               ;
        KStream<String, String> stringStringKStream = inputStream.mapValues(v -> v.getFirstName());
        KGroupedStream<String, String> myKGroupedStream = stringStringKStream.groupByKey(Grouped.with(Serdes.String(), Serdes.String()));
//        myKGroupedStream.
