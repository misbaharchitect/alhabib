...
public class KafkaAvroProducerStudentV1 {
...
//        properties.setProperty("bootstrap.servers", "127.0.0.1:9092");
        ...
        Student student = new Student("Adam", "21", List.of("Arts", "EVS"));
        ProducerRecord<String, Student> producerRecord = new ProducerRecord<>("avro-students",
                student);
//
