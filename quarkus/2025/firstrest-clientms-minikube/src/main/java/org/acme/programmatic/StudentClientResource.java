...
public class StudentClientResource {
    ...
    public StudentClientResource(@ConfigProperty(name="firstrestms.url", defaultValue = "http://firstrestms-minikube") String firstrestmsUrl) throws MalformedURLException {
        studentRestClient = RestClientBuilder.newBuilder()
                .baseUrl(new URL(firstrestmsUrl))
