...
public class StudentClientResource {
    ...
    public Response addStudent(Student student) {
        LOGGER.info("Add student with name {} from the REST client", student.getName());
        Response response = studentRestClient.addStudent(student);
        LOGGER.info("Response from the REST client {}", response);
        return response;
    }
